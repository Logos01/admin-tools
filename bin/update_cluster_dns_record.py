...
rawconfig = open('/etc/update_cluster_dns_config.json', 'r').read()
...
class data:
    '''
    variables defined here are dummy/unused values,
        unless generated by later functions.
    '''
    zone_id = 'Default'
